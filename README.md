...
> **Status: v0.9.2.** All five phases are built and the sync loop runs end to end: a sale on
...
```bash
docker pull ghcr.io/collectorscampus/multi-channel-inventory-hub:0.9.2
```
...
`image: ghcr.io/collectorscampus/multi-channel-inventory-hub:0.9.2`.
