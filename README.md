...
> **Status: v0.10.0.** All five phases are built and the sync loop runs end to end: a sale on
...
```bash
docker pull ghcr.io/collectorscampus/multi-channel-inventory-hub:0.10.0
```
...
`image: ghcr.io/collectorscampus/multi-channel-inventory-hub:0.10.0`.
